...
#line 402 "trad.y"
                                         { sprintf (temp, "%d", yyvsp[0].value) ;
                                           yyval.code = gen_code (temp) ; }
#line 2071 "trad.tab.c"
    break;

  case 85: /* operando: '(' expresion ')'  */
#line 404 "trad.y"
                                         { yyval = yyvsp[-1] ; }
#line 2077 "trad.tab.c"
    break;
