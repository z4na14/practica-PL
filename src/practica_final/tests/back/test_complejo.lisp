...
// Potencias sucesivas: p2=4, p4=16, p8=256, p16=65536
(setq p2 (* base base))
(setq p4 (* p2 p2))
(setq p8 (* p4 p4))
(setq p16 (* p8 p8))

// Suma aritmetica anidada: (3+5)*(10-4) / 2  =  24
(setq suma_anid (/ (* (+ 3 5) (- 10 4)) 2))

// Modulo y combinacion de operaciones
...
// --- Bucle while: acumula suma de 0..19 ---
...
// --- If/else sobre resultado del bucle ---
...
// --- If anidado: tres ramas con progn ---
...
// --- Bucle while con if/else en el cuerpo y progn ---
...
// --- defun main: computo tipo Fibonacci con logica compleja ---
