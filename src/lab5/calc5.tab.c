...
#line 26 "calc5.y"
                                          { memoria [(yyvsp[-3].indice)] = (yyvsp[-1].valor);
                                            printf ("%c=%lf\n", ((yyvsp[-3].indice) <= 26)? ((yyvsp[-3].indice)+'A') : ((yyvsp[-3].indice)+'a'-26), (yyvsp[-1].valor));
                                          }
